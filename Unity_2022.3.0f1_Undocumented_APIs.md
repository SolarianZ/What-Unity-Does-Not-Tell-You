...
- [Assembly] Editor/Data/Managed/PlayerBuildProgramLibrary.Data.dll
    - [Type] PlayerBuildProgramLibrary.Data.Plugin
        ...
        - [Field] Architecture
        - [Field] CompileFlags
        - [Field] AddToEmbeddedBinaries
    - [Type] PlayerBuildProgramLibrary.Data.PluginsData
        - [Field] Plugins
    - [Type] PlayerBuildProgramLibrary.Data.GenerateNativePluginsForAssembliesArgs
        - [Field] PluginOutputFolder
        - [Field] SymbolOutputFolder
        - [Field] Assemblies
    - [Type] PlayerBuildProgramLibrary.Data.GenerateNativePluginsForAssembliesSettings
        - [Field] HasCallback
        - [Field] DisplayName
        - [Field] AdditionalInputFiles
    - [Type] PlayerBuildProgramLibrary.Data.PlayerBuildConfig
        ...
        - [Field] Development
        - [Field] UseNewInputSystem
        - [Field] GenerateNativePluginsForAssembliesSettings
        - [Field] Services
        - [Field] ManagedAssemblies
        - [Field] StreamingAssetsFiles
    - [Type] PlayerBuildProgramLibrary.Data.BuiltFilesOutput
        - [Field] Files
        - [Field] BootConfigArtifact
...
- [Assembly] Editor/Data/Managed/Bee.TinyProfiler2.dll
    - [Type] Bee.Core.TinyProfiler2
        - [Method] ResetGlobalInstance
        - [Method] SetupNewTrack
        - [Method] AddExternalTraceEventsFile
        - [Method] Write
        - [Method] WriteChromeTrace
        - [Method] WriteChromeTraceEvents
        - [Property] Global
        - [Property] StartTime
        - [Property] ElapsedProfilerTime
        - [Property] CurrentThreadTrack
    - [Type] Bee.Core.Track
        - [Method] CreateEvent
        - [Method] SetEventDuration
        - [Method] SetEventDurationBasedOnCurrentTime
        - [Method] SetEventDurationBasedOnEndTime
        - [Property] Id
        - [Property] Name
        - [Property] ElapsedProfilerTime
        - [Property] ProfilerStartTime
    - [Type] Bee.Core.TraceEvent
    - [Type] Bee.Core.ChromeTraceOptions
        - [Field] EventDurationThreshold
        - [Field] ProcessId
        - [Field] ProcessName
        - [Field] ProcessSortIndex
        - [Field] ExternalTraceEventFiles
        - [Field] HeaderMetadata
    - [Type] Bee.Core.SectionDisposable
- [Assembly] Editor/Data/Managed/ScriptCompilationBuildProgram.Data.dll
    - [Type] ScriptCompilationBuildProgram.Data.Constants
        - [Field] ScriptAssembliesTarget
        - [Field] ScriptAssembliesAndTypeDBTarget
        - [Field] MovedFromExtension
    - [Type] ScriptCompilationBuildProgram.Data.ScriptCompilationData
        ...
        - [Field] BuildTarget
        - [Field] Localization
        - [Field] BuildPlayerDataOutput
        - [Field] ExtractRuntimeInitializeOnLoads
        - [Field] EnableDiagnostics
        - [Field] EmitInfoForScriptUpdater
        - [Field] AssembliesToScanForTypeDB
        - [Field] SearchPaths
    - [Type] ScriptCompilationBuildProgram.Data.AssemblyData
        ...
        - [Field] RuleSet
        - [Field] AnalyzerConfigPath
        - [Field] LanguageVersion
        - [Field] UseDeterministicCompilation
        - [Field] SuppressCompilerWarnings
        - [Field] Analyzers
